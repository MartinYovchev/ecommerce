        ...
        <div className={styles.tabContent}>
          {activeTab === 'mission' && (
            <div>
              ...
              <p>
                We're dedicated to exceptional customer service, sustainable
                practices, and celebrating the culture and community that
                surrounds sneaker collecting and wearing.
              </p>
            </div>
          )}
